...
service(9) OaUserAo {
	...
	void 6:logout(1:comm.PlatformArgs platformArgs, 2:i32 userId, 3:string userName) throws (1:comm.ErrorInfo err);
	...
	ECheckResult 9:checkSessionAndGroups(1:comm.PlatformArgs platformArgs, 2:i32 userId
		, 3:string userName, 4:string secretKey, 5:set<string> groups) throws (1:comm.ErrorInfo err);
}
