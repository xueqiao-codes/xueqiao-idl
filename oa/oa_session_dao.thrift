...
service(8) OaSessionDao {
	...
	list<TSession> 2:getSession(1:comm.PlatformArgs platformArgs, 2:i32 userId, 3:string userName) throws (1:comm.ErrorInfo err);
	
	void 3:deleteSession(1:comm.PlatformArgs platformArgs, 2:i32 userId, 3:string userName) throws (1:comm.ErrorInfo err);
}
